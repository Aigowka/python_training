...
class test_add-group(unittest.TestCase):
    def setUp(self):
        self.wd = WebDriver()
        self.wd.implicitly_wait(60)
    
    def test_test_add-group(self):
        success = True
        wd = self.wd
        ...
        wd.find_element_by_name("group_header").send_keys("adaa")
        wd.find_element_by_name("group_footer").click()
        wd.find_element_by_name("group_footer").clear()
        wd.find_element_by_name("group_footer").send_keys("dadasd")
